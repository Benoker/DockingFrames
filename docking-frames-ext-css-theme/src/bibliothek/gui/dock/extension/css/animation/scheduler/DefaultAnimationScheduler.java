...
/**
 * This {@link AnimationScheduler} ignores multible calls to its <code>step</code> methods,
 * and executes all <code>steps</code> in the <code>EventDispatcherThread</code>. 
 * @author Benjamin Sigg
 */
public class DefaultAnimationScheduler implements AnimationScheduler{
	private final Object LOCK = new Object();
	
	private PriorityQueue<Call> queue = new PriorityQueue<Call>();
	private Map<AnimationSchedulable, Call> calls = new HashMap<AnimationSchedulable, Call>();
	...
	private class Call implements Comparable<Call>{
		...
		public Call( AnimationSchedulable job, int delay ){
			this.job = job;
		...
		public void execute( long nanoNow ){
			...
			try{
				executing = this;
				job.step( DefaultAnimationScheduler.this, delay );
			}
			finally{
				executing = null;
			}
