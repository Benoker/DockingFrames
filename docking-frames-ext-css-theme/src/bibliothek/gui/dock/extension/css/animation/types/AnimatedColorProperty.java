 ...
 */
public class AnimatedColorProperty implements AnimatedCssProperty<Color>{
	private Color source;
	private Color target;
	private double transition;
	private AnimatedCssPropertyCallback<Color> callback;
	
	@Override
	public void setCallback( AnimatedCssPropertyCallback<Color> callback ){
