...
/**
 * This {@link CssAnimationProperty} handles values that are {@link CssPropertyContainer}s, and thus
 ...
 */
public abstract class CssContainerAnimationProperty<T extends CssPropertyContainer> extends CssAnimationProperty<T> {
	private T value;
	 ...
	 * @param scheme the scheme which manages the animation
	 * @param item the item that is animated
	 */
	public CssContainerAnimationProperty( CssScheme scheme, CssItem item ){
		super( scheme, item );
	}
