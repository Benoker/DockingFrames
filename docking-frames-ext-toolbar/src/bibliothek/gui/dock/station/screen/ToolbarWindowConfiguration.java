...
/**
 * This class will configure {@link ScreenDockWindow}s such that grabing the title of a toolbar does 
 * not start a drag and drop operation directly, but first allows the user to move around the entire
 * window.
