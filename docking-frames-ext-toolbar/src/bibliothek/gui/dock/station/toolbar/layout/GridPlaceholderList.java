...
/**
 * This {@link PlaceholderList} stores {@link Column}s as items, where one {@link Column}
 * is just another {@link PlaceholderList}.
...
public abstract class GridPlaceholderList<D, S, P extends PlaceholderListItem<D>> extends PlaceholderList<ColumnItem<D, S, P>, ColumnItem<D, S, P>, Column<D, S, P>> {
	/**
	 * This {@link PlaceholderListItemConverter} is used to read and write {@link Column}s, the default setting
	 * just ignores any reference to any {@link Dockable}.
	 */
	...
	/**
	 * Factory method creating an new {@link Column} that can be added to this list.
	...
	/**
	 * Sets the {@link PlaceholderListItemConverter} which should be used to convert the interal
	 * lists of this grid.
	...
	private class StationItem implements ColumnItem<D, S, P> {
		...
		@Override
		public ColumnItem<D, S, P>[] getChildren(){
			D[] children = getItemChildren( item );
			ColumnItem<D, S, P>[] result = new ColumnItem[children.length];
	...
	private class ColumnList implements Column<D, S, P> {
		private PlaceholderList<D, S, P> list;
		...
		@Override
		public ColumnItem<D, S, P>[] getChildren(){
			ColumnItem<D, S, P>[] result = new ColumnItem[list.dockables().size()];
			int index = 0;
