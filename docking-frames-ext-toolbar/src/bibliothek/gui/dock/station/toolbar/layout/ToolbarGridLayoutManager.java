...
public abstract class ToolbarGridLayoutManager<P extends PlaceholderListItem<Dockable>>
	...
	public void layoutContainer( Container parent ){
		...
		final Dimension preferred = layoutSize(components, Size.PREFERRED);
		if ((preferred.width <= available.width)
				&& (preferred.height <= available.height)){
			layout(components, preferred, available, Size.PREFERRED);
		} else{
			layout(components, layoutSize(components, Size.MINIMUM), available,
					Size.MINIMUM);
		}
	}
	 ...
	 */
	protected void layout( Wrapper[][] components, Dimension required,
