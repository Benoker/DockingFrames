...
/**
 * A converter used by the {@link PlaceholderToolbarGrid} when reading a {@link PlaceholderMap}.
...
public interface PlaceholderToolbarGridConverter<D,P extends PlaceholderListItem<D>> {
	/**
	 * Converts the {@link Dockable} <code>dockable</code> into an item that can be shown in the
	 * view. This method is also responsible for actually adding the item to the view.
