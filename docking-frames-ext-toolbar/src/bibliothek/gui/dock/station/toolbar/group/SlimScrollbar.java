...
public class SlimScrollbar extends JComponent implements ColumnScrollBar, Adjustable{
	...
	public SlimScrollbar(){
		...
		MouseAdapter adapter = new MouseAdapter(){
			...
			public void mouseReleased( MouseEvent e ){
				mousePressed = (e.getModifiersEx() & (MouseEvent.BUTTON1_DOWN_MASK | MouseEvent.BUTTON2_DOWN_MASK | MouseEvent.BUTTON3_DOWN_MASK)) != 0;
	...
	protected void paintComponent( Graphics g ){
		...
		if( orientation == Orientation.HORIZONTAL ){
			g.fillRect( value, 0, thumb, 6 );
		}
		else{
			g.fillRect( 0, value, 6, thumb );
		}
	}
