...
//		final int columnCount = stationHost.lineCount(column);
...
//		System.out.println("dockableCount" + dockableCount);
//		if (dockableCount <= 0){
//			return null;
//		}
//		// distances and closer dockable
...
//		// Graphics g = currentDockable.getComponent().getGraphics();
//		// g.setColor(Color.GREEN);
//		// currentDockable
//		// .getComponent()
//		// .getGraphics()
//		// .fillRect(currentBounds.x, currentBounds.y,
...
//				currentBounds.y);
//		fourCorners[2] = new Point((int) currentBounds.getMaxX(),
//				(int) currentBounds.getMaxY());
//		fourCorners[3] = new Point(currentBounds.x,
//				(int) currentBounds.getMaxY());
//		for (int i = 0; i < fourCorners.length; i++){
