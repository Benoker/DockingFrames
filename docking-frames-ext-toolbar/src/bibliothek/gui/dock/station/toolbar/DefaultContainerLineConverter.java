...
/**
 * Default implementation of {@link ContainerLineConverter}. This converter supports all features
 * necessary to read and write {@link PlaceholderMap}s.
 * @author Benjamin Sigg
 * @author Herve Guillaume
 */
public class DefaultContainerLineConverter implements ContainerLineConverter {
	@Override
	public PlaceholderMap getPlaceholders( ContainerLineStation station ){
		PlaceholderMap result = new PlaceholderMap( new Path( "dock.ContainerLineStation" ), 0 );
	...
	private PlaceholderMap convert( ContainerLineStation station, DockablePlaceholderList<StationChildHandle> list, final Map<Dockable, Integer> children ){
	...
	private void convert( final ContainerLineStation station, final ContainerLineConverterCallback callback, PlaceholderMap map, final Map<Integer, Dockable> children ){
