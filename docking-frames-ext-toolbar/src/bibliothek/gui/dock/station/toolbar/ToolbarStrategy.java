...
public interface ToolbarStrategy{
	 ...
	 */
	public static final PropertyKey<ToolbarStrategy> STRATEGY = new PropertyKey<ToolbarStrategy>(
			"dock.toolbarStrategy",
			new ConstantPropertyFactory<ToolbarStrategy>(
					new DefaultToolbarStrategy()), true);
	 ...
	 *            indirect parent of <code>child</code>
	 * @param child
	 *            some {@link Dockable} that is going to be a direct or indirect
	 ...
	 * 
	 * @param parent
	 *            a potential parent for <code>child</code>. It might be that an
	 *            additional layer between <code>parent</code> and
	 *            <code>child</code> will be created.
	 * @param child
	 *            the potential new child of <code>parent</code>
	 * @param strongRelation
	 *            if <code>true</code>, then it must be possible to add
	 *            <code>child</code> directly to <code>parent</code>, if
	 *            <code>false</code> the relation must be valid after calling
	 *            {@link #ensureToolbarLayer(DockStation, Dockable)}.
	 * @return <code>true</code> if a combination between <code>child</code> and
	 *         <code>parent</code> is possible
	 */
	public boolean isToolbarGroupPartParent( DockStation parent,
			Dockable child, boolean strongRelation );
	 ...
	 * @return <code>true</code> if <code>dockable</code> represents a group of
	 *         toolbar components
	 */
	 ...
	 * @param dockable
	 *            the element to test
	 * @return <code>true</code> if <code>dockable</code> represents a toolbar
	 *         or a part of a toolbar
	 */
