...
/**
 * Describes the location of a child of a {@link ContainerLineStation}.
 * 
 * @author Benjamin Sigg
 * @author Herve Guillaume
 */
public class ContainerLineProperty extends AbstractDockableProperty{
	 ...
	 */
	public ContainerLineProperty( int index, Path placeholder ){
		this.index = index;
		this.placeholder = placeholder;
	}

	public DockableProperty copy(){
		ContainerLineProperty copy = new ContainerLineProperty(index,
				placeholder);
