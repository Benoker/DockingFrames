...
\begin{enumerate}
 ...
 \item Global information describes the relationship of an entire tree of \src{Dockable}s and \src{DockStation}s. The class \src{DockSituation} offers methods to extract and to apply this data.
\end{enumerate}
