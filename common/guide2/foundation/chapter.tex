...
A \src{dockable} is either visible or invisible, the user can only interact with the \src{dockable} if it is visible. Visibility can change through a set of events:
