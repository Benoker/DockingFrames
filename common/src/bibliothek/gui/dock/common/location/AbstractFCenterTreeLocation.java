 ...
 */
public abstract class AbstractFCenterTreeLocation extends AbstractStackholdingLocation{
	 ...
	 */
	public AbstractFCenterTreeLocation( double size, Side side ){
		if( size < 0 )
	 ...
	 */
	public FCenterTreeLocationNode north( double size ){
		return new FCenterTreeLocationNode( this, size, Side.NORTH );
	}
	 ...
	 * @return the new location
	 */
	public FCenterTreeLocationNode south( double size ){
		return new FCenterTreeLocationNode( this, size, Side.SOUTH );
	}
	 ...
	 * @return the new location
	 */
	public FCenterTreeLocationNode east( double size ){
		return new FCenterTreeLocationNode( this, size, Side.EAST );
	}
	 ...
	 * @return the new location
	 */
	public FCenterTreeLocationNode west( double size ){
		return new FCenterTreeLocationNode( this, size, Side.WEST );
	}
