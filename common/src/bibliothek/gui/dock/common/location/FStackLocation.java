 ...
 *
 */
public class FStackLocation extends AbstractStackholdingLocation{
	/** the index of the tab of this location */
	private int index;
	/** location of the stack */
	private FLocation parent;
	
	/**
	 * Creates a new location
	 * @param parent the location of the stack
	 */
	public FStackLocation( FLocation parent ){
	 ...
	 */
	public FStackLocation( FLocation parent, int index ){
		if( parent == null )
