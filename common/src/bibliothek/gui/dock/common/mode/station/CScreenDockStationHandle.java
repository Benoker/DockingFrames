 ...
 */
public class CScreenDockStationHandle extends ScreenDockStationHandle implements CExternalizedModeArea {
	/** base location */
	 ...
	 */
	public CScreenDockStationHandle( String id, ScreenDockStation station, CLocation location ){
		super( id, station );
