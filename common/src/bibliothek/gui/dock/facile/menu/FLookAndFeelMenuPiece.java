...
import bibliothek.gui.dock.common.lookandfeel.DockableCollector;
import bibliothek.gui.dock.common.menu.LookAndFeelMenuPiece;
import bibliothek.gui.dock.facile.DestroyHook;
 ...
 */
public class FLookAndFeelMenuPiece extends LookAndFeelMenuPiece implements DestroyHook{
     ...
     */
    public FLookAndFeelMenuPiece( FControl control ){
        super();
        ...
        try {
            control.getResources().put( "FLookAndFeelMenuPiece", new ApplicationResource(){
