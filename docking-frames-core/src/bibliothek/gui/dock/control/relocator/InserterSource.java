...
public interface InserterSource {
	...
	/**
	 * Gets the position of the dragged title
	 * @return the x-location of the dragged title or {@link #getMouseX()} if no
     * title is dragged
	 */
	...
	/**
	 * Gets the position of the dragged title
	 * @return the y-location of the dragged title or {@link #getMouseY()} if no
     * title is dragged
	 */
	...
	/**
	 * Gets the {@link Dockable} which might be the newest child of {@link #getParent()}.
	 * @return the future child, never <code>null</code>
	 */
