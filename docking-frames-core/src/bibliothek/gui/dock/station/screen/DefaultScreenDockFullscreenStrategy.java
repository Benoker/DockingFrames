...
/**
 * This default implementation of a {@link ScreenDockFullscreenStrategy} just works with the boundaries of a
 * {@link ScreenDockWindow}. It assumes that either {@link ScreenDockDialog} or {@link ScreenDockFrame} is used.
 * Subclasses may extend this list, the algorithms of this strategy should work with most implementations that are based
 * on a {@link Window}.
 *
...
public class DefaultScreenDockFullscreenStrategy implements ScreenDockFullscreenStrategy {
    ...
    /**
     * Tries to find the boundaries that match the fullscreen-criterium and that match the current location of
     * <code>window</code>.
     *
