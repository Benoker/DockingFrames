...
public class EclipseDockableDisplayer2 extends BasicDockableDisplayer{
	 ...
	 */
	public EclipseDockableDisplayer2( EclipseTheme theme, DockStation station, Dockable dockable, DockTitle title ){
		super( station, false );
		...
		observer = new TitleBarObserver( station, dockable, TitleBar.ECLIPSE ){
			...
			protected void invalidated(){
				for( DockableDisplayerListener listener : listeners() ){
					listener.discard( EclipseDockableDisplayer2.this );
				}
			}
		};
